...
const kits: Kit[] = [
  {
    ...
    items: [
      { name: 'One Pocket Blade Folder', designID: 8487, contentID: 40176, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Two Pocket Folder', designID: 8545, contentID: 40235, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Daily Counter Telephone Log', designID: 8488, contentID: 40177, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Parts Quote and Call Log', designID: 8489, contentID: 40178, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Inspection Form', designID: 8490, contentID: 40179, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Rental Contract Rev 1/22', designID: 8787, contentID: 40617, recommendedQty: 2, isInventory: true, qtyInCart: 0 },
      { name: 'Daily Service Call Log', designID: 8491, contentID: 40180, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Service Report', designID: 8786, contentID: 40616, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Vehicle Mileage Report', designID: 8492, contentID: 40181, recommendedQty: 3, isInventory: true, qtyInCart: 0 },
      { name: 'CONNECT Flyer', designID: 8834, contentID: 43161, recommendedQty: 3, isInventory: true, qtyInCart: 0 },
      { name: 'Rentals Flyer', designID: 9011, contentID: 43167, recommendedQty: 3, isInventory: true, qtyInCart: 0 },
      { name: 'Used Equipment Website Flyer', designID: 9014, contentID: 43169, recommendedQty: 3, isInventory: true, qtyInCart: 0 },
      { name: "Now Hiring 3' x 10' with QR Code", designID: 8866, contentID: 40720, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: "Now Open Banner 3.5' x 8'", designID: 8859, contentID: 40713, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: "Silhouette Banner 4' x 8'", designID: 8862, contentID: 40716, recommendedQty: 2, isInventory: true, qtyInCart: 0 },
      { name: 'Code of Conduct Ethics Poster', designID: 8496, contentID: 40185, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Ethics Violation Poster', designID: 8552, contentID: 40247, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Refer and Receive Poster', designID: 8553, contentID: 40248, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'LiveSafe Banner', designID: 8497, contentID: 40186, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'LiveSafe Cling', designID: 8826, contentID: 40675, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'LiveSafe Poster', designID: 8827, contentID: 40676, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: "Poster Frame 2' x 3'", designID: 8828, contentID: 40677, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: "Wash Rack Safety Sign 2' x 3'", designID: 8829, contentID: 40678, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Join Our Team Recruiting Cards', designID: 8503, contentID: 40192, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Thank You Card and Envelope', designID: 8504, contentID: 40193, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Field Service Repair Tag Wires Attached', designID: 8505, contentID: 40194, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
      { name: 'Ready to Rent Tag Loose Wires', designID: 8824, contentID: 40673, recommendedQty: 3, isInventory: true, qtyInCart: 0 },
      { name: 'Warranty Parts Tag 3-Ply', designID: 8825, contentID: 40674, recommendedQty: 1, isInventory: true, qtyInCart: 0 },
    ],
    isDynamic: false,
