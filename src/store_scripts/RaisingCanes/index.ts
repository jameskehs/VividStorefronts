...
const pricingTiers: { name: string; boxPricing: number }[] = [
  { name: "Value", boxPricing: 10.29 },
  //  { name: "Boston", boxPricing: 10.89 },
  { name: "Value +", boxPricing: 10.89 },
  //  { name: "Portland", boxPricing: 10.79 },
  { name: "Base", boxPricing: 11.49 },
  ...
  { name: "Las Vegas Strip", boxPricing: 12.99 },
  { name: "CA High", boxPricing: 12.99 },
  { name: "CA High+", boxPricing: 13.39 },
  { name: "Base +20%", boxPricing: 13.49 },
  { name: "Broadway - Nashville", boxPricing: 13.49 },
  //  { name: "Potential Base +20%", boxPricing: 13.19 },
  { name: "Bay Area, CA", boxPricing: 14.49 },
  { name: "NYC", boxPricing: 14.99 },
  { name: "Time Square", boxPricing: 15.49 },
];
