...
export function main() {
  ...
  if (
    ...
    $(".checkoutProgress").append(
      "<h1 style='max-width:900px; margin:0 auto; padding: 24px 0'>All T-shirt orders must be received by Wednesday, September 23, 2026. You may choose direct shipping via USPS to your shipping address provided or pick up at Prisma Baton Rouge, <a href='https://www.google.com/maps?q=8640+Airline+Hwy,+Baton+Rouge,+LA+70815' target='_blank'>8640 Airline Hwy, Baton Rouge, LA 70815</a>. Shirts will be available for pick up on October 9th.\nPrisma is open Monday - Friday 8 AM-5 PM.</h1>",
    );
  }
}
