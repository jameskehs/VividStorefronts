...
(() => {
  ...
  r.innerHTML = `<button id="vivid-chat-btn" title="Chat">💬</button><div id="vivid-chat-panel" role="dialog" aria-label="Vivid Assistant"><div id="vivid-chat-head">Vivid Assistant <button id="vivid-chat-close" title="Close">✕</button></div><div id="vivid-chat-log" aria-live="polite"></div><form id="vivid-chat-form"><input id="vivid-chat-input" placeholder="Type a message…" autocomplete="off" /><button id="vivid-chat-send" type="submit">Send</button></form></div>`;
